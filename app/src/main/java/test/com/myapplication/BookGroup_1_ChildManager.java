...
public class BookGroup_1_ChildManager extends OneHeaderGroupChildManager {

    public BookGroup_1_ChildManager(GridLayoutManager gridLayoutManager) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int viewType, int dataPositionInGroup) {
        ((TextView)viewHolder.itemView).setText("横向内容item---:"+dataPositionInGroup);
